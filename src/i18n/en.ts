const en = {
  ...
  nothingSelectedInfo: 'No layers selected — creating a minimal project with all skills.',
  ...
  notAgentforgeProject: 'Not in an agentforge project (.claude/ directory not found).',
